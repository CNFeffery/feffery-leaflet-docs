                ...
                [
                    flc.LeafletMap(
                        [
                            ...
                            flc.LeafletGeoJSON(
                                id='geojson-selectable-multiple',
                                data=(
                                    requests
...
@app.callback(
    Output('selectable-multiple-result', 'children'),
    Input('geojson-selectable-multiple', 'selectedFeatureIds')
)
def selectable_multiple_callback(selectedFeatureIds):
...
''')
    ...
    id='LeafletGeoJSON-selectable-multiple-container',
    sizes=[60, 40],
    gutterSize=10,
    style={
        'height': '100%'
